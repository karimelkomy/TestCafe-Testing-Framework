...
} from './enterpriseRolesDetails';
import { pendingOffersWorkspaceAdminRoleDetails } from './resellerRolesDetails';
...
export const BudgetsAdminUserDetails = (orgType) => {
	return {
		firstName: chance.first(),
		lastName: chance.last(),
		email: `${generateRandomEmail(`${orgType}.budget`)}`,
		phoneNumber: chance.phone({ formatted: false }),
		position: generateRandomAlphabetic(),
		rolesName: budgetsAdminRoleDetails.rolesName,
	};
};
