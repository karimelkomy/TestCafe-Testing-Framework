...
import customData from '../../../data/saas/dataProvider/reseller-organization/reseller-organization';
import existingCustomData from '../../../data/saas/dataProvider/reseller-organization/existing-reseller-organization';
...
fixture`Reseller Organization - Setup`
	.page(buyerUrl)
	.beforeEach(async (t) => {
...
fixture`Reseller Organization - Product Request`
	.page(buyerUrl)
	.beforeEach(async (t) => {
		await t.maximizeWindow();
		await t.setNativeDialogHandler(() => true);
...
test('Create a product request using a client basic user - With approval workflow - Successfully', async (t) => {
	...
	customTest: 'reseller-organization-product-request_create-product-request-using-client-basic-user_with-approval-workflow-successfully',
});
...
test('Create a manual product request using a client E-source admin user with partial GRN/GDN - Send for revision - Successfully', async (t) => {
	...
	customTest:
		'reseller-organization-product-request_create-manual-product-request-using-client-esource-admin-user-with-partial-grn-gdn_send-for-revision-successfully',
});
...
test('Create a product request using basic user and source from preferred vendor in E-source with partial GRN - Successfully', async (t) => {
	...
	customTest:
		'reseller-organization-product-request_create-product-request-using-basic-user-and-source-from-preferred-vendor-in-esource-with-partial-grn-successfully',
});
...
test('Create a product request using default workspace, with RFQ sourcing from vendors - Send for revision - Successfully', async (t) => {
	...
	customTest:
		'reseller-organization-product-request_create-product-request-using-default-workspace-with-rfq-sourcing-from-vendors_send-for-revision-successfully',
});
...
test('Create a product request from e-source, with RFQ sourcing from preferred vendor - Negotiation offer - Successfully', async (t) => {
	...
	customTest:
		'reseller-organization-product-request_create-product-request-from-esource-with-rfq-sourcing-from-preferred-vendor_negotiation-offer-successfully',
});
...
test('Create a product request from action-board and source from E-source, with RFQ sourcing from vendors - Update offer offline - Successfully', async (t) => {
	...
	customTest:
		'reseller-organization-product-request_create-product-request-from-action-board-and-source-from-esource-with-rfq-sourcing-from-vendors_update-offer-offline-successfully',
});
...
test('Create a manual product request, with RFQ sourcing from vendors - Successfully', async (t) => {
	...
	customTest: 'reseller-organization-product-request_create-manual-product-request-with-rfq-sourcing-from-vendors-successfully',
});
...
test('Create a bulk product request, with RFQ sourcing - Successfully', async (t) => {
	...
	customTest: 'reseller-organization-product-request_create-bulk-product-request-with-rfq-sourcing-successfully',
});
...
test('Create a product request and source RFQ from vendor with contract - Successfully', async (t) => {
	...
	customTest: 'reseller-organization-product-request_create-product-request-and-source-rfq-from-vendor-with-contract-successfully',
});
...
test('Create a product request, with order sourcing - Successfully', async (t) => {
	...
	customTest: 'reseller-organization-product-request_create-product-request-with-order-sourcing-successfully',
});
...
test('Create a product request and order sourcing with contract - Successfully', async (t) => {
	...
	customTest: 'reseller-organization-product-request_create-product-request-and-order-sourcing-with-contract-successfully',
});

fixture`Reseller Organization - Reimbursement Request`
	.page(buyerUrl)
	.beforeEach(async (t) => {
		await t.maximizeWindow();
		await t.setNativeDialogHandler(() => true);
...
test
	...
	.meta({
		customTest: 'reseller-organization-product-reimbursement_create-reimbursement-request-successfully',
	});

fixture`Reseller Organization - Bills`
	.page(buyerUrl)
	.beforeEach(async (t) => {
		await t.maximizeWindow();
		await t.setNativeDialogHandler(() => true);
...
test('Create advance bill - Successfully', async (t) => {
	...
	customTest: 'reseller-organization-bills-create-advance-bill-successfully',
});
...
test('Create expense bill - Successfully', async (t) => {
	...
	customTest: 'reseller-organization-bills-create-expense-bill-successfully',
});

fixture`Reseller Organization - Cleanup`
	.beforeEach(async (t) => {
		await t.maximizeWindow();
		await t.setNativeDialogHandler(() => true);
	})
