...
export default class GrnsPage {
	...
	async openFirstGrn({ productRequest }) {
		...
		await this.grnsList.selectFirstGrn({ requestDetails, workspaceDetails, requesterUserDetails });
	}
	...
	async openClientFirstGrn({ productRequest }) {
		...
		await this.grnsList.selectFirstGrn({ requestDetails, workspaceDetails, requesterUserDetails: clientRequesterUserDetails });
	}
}
