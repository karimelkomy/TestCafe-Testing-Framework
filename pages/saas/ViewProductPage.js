...
export default class ViewProductPage {
	...
	async validateProduct({ productDetails, organizationDetails }) {
		...
		await this.productDetailsModule.validateProductDetailsModule({ productDetails });
		await this.productSpecsModule.validateProductSpecsModule({ productDetails });
		await this.productSummary.validateProductSummaryModule({ productDetails, organizationDetails });
	}
}
